...
public class AppControllerTest_putPhoneInPreferences {
    ...
    public void shouldCallEditOnPreferences() throws NoSuchFieldException, IllegalAccessException {
        ...
        //when
        appController.putPhoneInPreferences("");
        //then
    ...
    public void shouldCallPutStringOnEditor() throws NoSuchFieldException, IllegalAccessException {
        ...
        //when
        appController.putPhoneInPreferences(phoneNumber);
        //then
        verify(editor).putString(Constants.Preferences.PHONE_NUMBER, phoneNumber);
    }
